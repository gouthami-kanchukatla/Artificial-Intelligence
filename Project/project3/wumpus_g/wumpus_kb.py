...
def axiom_generator_wumpus_alive_ssa(t):
    ...
    w_state_1=state_wumpus_alive_str(t)         # wumpus alive at previous percepts
    w_state_2=state_wumpus_alive_str(t+1)       #wumpus alive at current percepts
    scream_status=percept_scream_str(t+1)           # wumpus scream
    axiom_str = '{0} <=> ({1} & ~{2})'.format(w_state_2,w_state_1,scream_status)  #merging the statement
    return(axiom_str)
...
def axiom_generator_heading_east_ssa(t):
    ...
    no_move = '({0} & ({1} | {2} | {3} | {4} | {5}))'.format(s_1,a_1,a_2,a_3,p_1,a_4)  
    axiom_str = '{0} <=> ({1} | {2} | {3})'.format(state_heading_east_str(t+1),no_move,left,right) 
    return(axiom_str)
...
def axiom_generator_heading_only_north(t):
    ...
    #merging the conditions
    axiom_str =  '{0} <=> (~{1} & ~{2} & ~{3})'.format( n, s, e, w) 
    return(axiom_str)
...
def axiom_generator_heading_only_south(t):
    ...
    #merging the conditions
    axiom_str = '{0} <=> (~{1} & ~{2} & ~{3})'.format(s,n,e,w) 
    return(axiom_str)
...
def axiom_generator_heading_only_west(t):
   ...
   "*** YOUR CODE HERE ***"
    ...
    #merging the conditions
    axiom_str = '{0} <=> (~{1} & ~{2} & ~{3})'.format(w,s,e,n) 
    return(axiom_str)
